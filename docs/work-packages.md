...
| MOL-WP-10 | Project graph and broader Laravel knowledge | Project graph indexing exists. Laravel knowledge now covers queues, routing, testing, validation, the container, Eloquent, and events. Implementation prompts receive bounded advisory neighborhoods. A visual Bloom view remains |
