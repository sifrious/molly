...
| MOL-WP-10 | Project graph and broader Laravel knowledge | Project graph indexing exists. Laravel knowledge now covers queues, routing, testing, and validation. A visual Bloom view remains |
