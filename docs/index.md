...
| Query Laravel queue and routing knowledge | [Laravel knowledge](knowledge-graph.md) |
...
The Laravel knowledge graph currently covers queues and routing. The project graph covers saved Molly records in one workspace. Remote Orb identity and Bloom-owned pull requests are still planned. Visual previews are optional and advisory.
