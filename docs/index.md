...
| Query Laravel queue, routing, and testing knowledge | [Laravel knowledge](knowledge-graph.md) |
...
The Laravel knowledge graph currently covers queues, routing, and testing. The project graph covers saved Molly records in one workspace. Remote Orb identity and Bloom-owned pull requests are still planned. Visual previews are optional and advisory.
