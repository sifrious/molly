...
| Query Laravel queue, routing, testing, and validation knowledge | [Laravel knowledge](knowledge-graph.md) |
...
The Laravel knowledge graph currently covers queues, routing, testing, and validation. The project graph covers saved Molly records in one workspace. Remote Orb identity and Bloom-owned pull requests are still planned. Visual previews are optional and advisory.
