...
- [Clone Bloom and finish the Molly loop](handoffs/COMBINE-BLOOM-AND-MOLLY.md) is the next-agent handoff for MOL-WP-02. The Swift adapter already exists under [docs/handoffs/bloom-adapter](handoffs/bloom-adapter/README.md). Copy it. Do not rebuild it.
