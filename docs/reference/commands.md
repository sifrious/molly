...
The project graph is separate from Laravel queue, routing, testing, validation, and container knowledge. It is rebuilt from saved tasks and attempts in the named workspace.
