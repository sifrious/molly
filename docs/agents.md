...
| `molly_task` | Creates and manages saved tasks, names, thread links, advice, and lifecycle requests. |
...
Then `molly_knowledge` can return a bounded, version-matched queue neighborhood with source provenance.
