...
<p class="hint" id="test-help">A PHP file under tests/. Molly includes this test in the files Molly may change.</p>
...
<p class="hint" id="paths-help">One repository-relative path per line. Leave this empty for a task that only changes the required test.</p>
